...
depth $n_{row}$; SP1 proves the correctness of this circuit evaluation via the GKR polynomial IOP \rnote{interactive proof, not a PIOP}.
...
The jagged PCS\footnote{\url{https://eprint.iacr.org/2025/917}} bridges the two representations without the prover ever materializing
the padded columns.
...
stacked \textbf{BaseFold}, the multilinear variant of FRI.
