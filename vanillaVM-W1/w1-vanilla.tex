...
because it 1) does not normalize the proof to fit \texttt{compress\_shape} and 2) it uses
...
The \texttt{compose} and \texttt{shrink} programs enforces VK authentication:
